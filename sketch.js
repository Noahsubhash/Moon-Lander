...
function setup() {
  ...
  //set the collider for lz (rectangle shape  with 180 y axis, 400 width and 100 height)
...
function draw() 
{
  ...
  //show the text for fuel at 800 and 25 position 
  ...
  if(lander.collide(obs)==true)
  {
       ...
       //change the animation of lander
    stop();
  }
